...
--
-- Host: 127.0.0.1
-- Tempo de geração: 01/11/2024 às 01:12
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `DesativarFornecedorPorEmail` (IN `emailFornecedorIN` INT)   BEGIN
    IF NOT EXISTS (SELECT idFornecedor FROM fornecedores WHERE email like emailFornecedorIN AND desativado != 1)
    THEN
        SELECT '403' AS 'Status', 'ERROR_FORNECEDOR_NAO_ENCONTRADO' AS 'Error', '' AS 'Message';
    ELSE
        UPDATE fornecedores SET desativado = 1 WHERE email = emailFornecedorIN;
        SELECT
            '204' AS 'Status',
            '' AS 'Error',
            'SUCCESS_DELETED' AS 'Message';
...
(2, 1, '2024-10-01 10:30:00', '2024-10-01 11:00:00', 0, NULL, 1, 150.75, 3, NULL, NULL, 'Concluído', NULL),
(3, 1, '2024-10-02 14:15:00', NULL, 1, 'R123456789', 2, 200.00, 5, NULL, NULL, 'Aguardando Pagamento', 2),
(4, 1, '2024-10-03 09:00:00', '2024-10-03 09:45:00', 1, 'R987654321', 1, 120.50, 2, NULL, NULL, 'Concluído', 2),
(5, 1, '2024-10-04 11:30:00', NULL, 0, NULL, 3, 175.90, 4, NULL, NULL, 'Aguardando Envio', NULL),
(6, 1, '2024-10-05 13:45:00', NULL, 0, NULL, 2, 250.00, 6, NULL, NULL, 'Aguardando Pagamento', NULL),
(7, 1, '2024-10-06 15:00:00', '2024-10-06 15:30:00', 1, 'R246813579', 1, 300.25, 1, NULL, NULL, 'Concluído', NULL),
(8, 1, '2024-10-07 08:15:00', NULL, 1, 'R135792468', 3, 130.99, 3, NULL, NULL, 'Aguardando Envio', NULL),
(9, 1, '2024-10-08 19:00:00', NULL, 0, NULL, 1, 90.00, 2, NULL, NULL, 'Aguardando Pagamento', NULL),
(11, 1, '2024-10-22 01:16:55', NULL, 0, NULL, 1, NULL, 6, NULL, NULL, 'Aguardando Pagamento', NULL),
(12, 1, '2024-10-31 20:46:50', NULL, 1, NULL, 1, NULL, 6, NULL, NULL, 'Aguardando Pagamento', NULL),
(13, 1, '2024-10-31 21:16:54', NULL, 1, NULL, 1, NULL, 6, NULL, NULL, 'Aguardando Pagamento', NULL),
(14, 1, '2024-10-31 21:18:43', NULL, 1, NULL, 1, NULL, 6, NULL, NULL, 'Aguardando Pagamento', NULL),
(15, 1, '2024-10-31 22:36:12', NULL, 0, NULL, 1, NULL, 6, NULL, NULL, 'Aguardando Pagamento', NULL);
