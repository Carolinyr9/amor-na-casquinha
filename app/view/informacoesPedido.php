...
<body>
    ...
    ?>
    <main>
        <h1 class="m-auto text-center pt-4 pb-4">Informações do Pedido</h1>
        <div class="conteiner">
            <div class="conteiner1">
                ...
                <div class="c1">
                    <div class="c2">
                        <?php
                        $pedidoController->listarPedidoPorId($_GET['idPedido']);

                        $entregadorController->listarEntregadorPorId($_SESSION['idEntregador']);
                        ?>
                    </div>
                </div>
            </div>
