    ...
    <main>
        <section>
            <div class="container d-flex flex-column justify-content-center align-items-center rounded-4 p-4">
                ...
                <div class="d-flex flex-row flex-wrap justify-content-between align-items-start gap-4 my-3">
                    <div class="d-flex align-items-center flex-column text-center p-3 w-25">
